<template>
    <div class="adduserBox">
        <el-form :model="changeInfoForm" :rules="rules" ref="changeInfo">
            <el-form-item label="用户名" prop="userComment" :label-width="formLabelWidth">
                <el-input style="width: 300px;" v-model="changeInfoForm.userComment" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="账号" prop="userName" :label-width="formLabelWidth">
                <el-input style="width: 300px;" v-model="changeInfoForm.userName" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="密码" prop="passWord" :label-width="formLabelWidth">
                <el-input style="width: 300px;" v-model="changeInfoForm.passWord" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="邮箱" prop="userEmail" :label-width="formLabelWidth">
                <el-input style="width: 300px;" v-model="changeInfoForm.userEmail" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="手机号" prop="userMobile" :label-width="formLabelWidth">
                <el-input style="width: 300px;" v-model="changeInfoForm.userMobile" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="用户类型" prop="type" :label-width="formLabelWidth">
                <el-input style="width: 300px;" v-model="changeInfoForm.type" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="用户描述" prop="userDescription" :label-width="formLabelWidth">
                <el-input style="width: 300px;"  v-model="changeInfoForm.userDescription" autocomplete="off"></el-input>
            </el-form-item>
        </el-form>
